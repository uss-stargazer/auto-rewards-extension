import { devLog, waitForTab } from "../modules/utils";
import {
  AarpActivity,
...
async function updateAarpTab(
  ...
  devLog("updateAarpTab", "updating:", update);
  ...
  const aarpTab = await waitForTab(updatedTab.id!);
  devLog("updateAarpTab", "got updated:", aarpTab);
  return aarpTab;
}
